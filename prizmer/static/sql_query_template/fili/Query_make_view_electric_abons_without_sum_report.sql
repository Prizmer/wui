...
CREATE OR REPLACE VIEW electric_abons_without_sum_report AS 
 SELECT electric_abons_report.account_2, electric_abons_report.date_install, 
    ...
    (electric_abons_report.factory_number_manual||'-'||"substring"(electric_abons_report.type_energo, char_length(electric_abons_report.type_energo), char_length(electric_abons_report.type_energo))) as report_num_meter
